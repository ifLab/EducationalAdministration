...
public abstract class BaseProvider {
     ...
     *
     * @param url       请求地址
     * @param params    请求非必传参�? * @param mustParams 请求必传参数
     * @param headers   自定义请求头
     * @param content   请求字符�? * @param charSet 请求字符串编码格�? * @param inputStream 请求参数�?
     *                  * @param inputStreamLength 请求参数流长�? * @param needAccessToken
     *                  是否�?��授权
     * @param paramType 此次请求参数类型
     * @return
     * @throws Exception
     */
     ...
     *
     * @param url
     * @param params 用户自定义参�? * @param mustParams 必传参数
     * @return
     * @throws Exception
     */
